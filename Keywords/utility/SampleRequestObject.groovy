...
class SampleRequestObject {
	 ...
	 */
		...
		String inputFile2 = new File(RunConfiguration.getProjectDir() + "/Data Files/companies.json").getText('UTF-8')
		
		
		TestObjectProperty header1 = new TestObjectProperty("Authorization", ConditionType.EQUALS, "Basic cmxld2lzOlFDMkVWS0hQNnpzOGJ1RTJecEJyTlh0eg==")
		TestObjectProperty header2 = new TestObjectProperty("Content-Type", ConditionType.EQUALS, "application/json")
		TestObjectProperty header3 = new TestObjectProperty("x-compass-firm-id", ConditionType.EQUALS, "822")
		TestObjectProperty header4 = new TestObjectProperty("x-compass-api-key", ConditionType.EQUALS, "dbf97abb-6905-42c7-b645-f8941a225fe7")
		...
		.withRestUrl(GlobalVariable.url + "/api/companies")
		.withHttpHeaders(defaultHeaders)
		.withRestRequestMethod("POST")
		.withTextBodyContent(inputFile2)
		.build()
